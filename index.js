 ...
 * }
*/
function makePersonObject(number, firstname, emailadd) {
  let personInfo = {
    id: number,
    name: firstname,
    email: emailadd,
...
*/
function makeSmartPerson(Objname, num1, num2) {
  let Obj = {
    name: Objname,
...
*/
function carMaker(odometerArg) {
  carObj = {
    drive: function drive(distance) {
      return carObj.odometer += distance;
    },
    odometer: odometerArg,
  }
  return carObj
}
